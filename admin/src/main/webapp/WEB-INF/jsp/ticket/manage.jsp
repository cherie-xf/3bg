			      ...
			      <tr>  
			       ...
			       <td>
                     	...
                     	<c:choose>
  							...
  							<a class="openEditPage " href="<c:url value="/ticket/operate.html?id=${var.id}&userLevel=${role}"/>" >
  							...
  							<span class="glyphicon glyphicon-zoom-in text-info" title="查看"></span>  </a>
   							...
   							<c:otherwise>
   							 ...
   							 <a class="openEditPage " href="<c:url value="/ticket/operate.html?id=${var.id}&userLevel=normal"/>">
  							<span class="glyphicon glyphicon-zoom-in text-info" title="查看"></span>  </a>
   							 </c:otherwise> 
 						</c:choose>

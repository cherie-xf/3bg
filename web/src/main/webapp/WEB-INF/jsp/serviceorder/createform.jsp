...
<!-- 			<div class="row">
	           <div class="col-sm-12">
		           <div class="form-group">	             
		              <h2 style="text-align:left; padding:10px">下订单</h2>	             
		           </div>
	           </div>
          	 </div>  -->         	 
<%-- 			 <div class="row myrow">						
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10 form-control-static">
                                  <div class="col-sm-12">
                                      ...
                                      <label id='nameLabel'>${serviceOrder.last_name}, ${serviceOrder.first_name}</label>
                                  </div>
                              </div>
                          </div>
                      </div>
                              ...
                              <div class="col-sm-10">                                   
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-sm-4">
												<form:input path="postcode" class="form-control" placeholder="邮编"/>
											</div>
										</div>
									</div>                    
                              </div>
		...
		//Ajax call to update user info when selecting a user.
 		function getUser() {
		    ...
		    $.get("../serviceorder/getUserAndCMember.json?user_id=" + user_id, function(data,status){
		    	...
		    	$("#nameLabel").html(data.last_name + ', ' + data.first_name);

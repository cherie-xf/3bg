		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">确认取消订单</h4>
				</div>
				...
				<div class="modal-footer">
					...
					<a href="#" class="btn btn-danger danger" id="modal-delete">确定</a>
				</div>
			</div>
		</div>
	</div>
	
	<div class="modal fade" id="confirm-message" tabindex="-1"
		role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel">订单取消结果</h4>
				</div>	
				<div class="modal-body">
					<p class="info"></p>
					<p></p>
				...
				<div class="modal-footer">
					<a href="buyermanage.html" class="btn btn-default" >确定</a>					
				</div>
			</div>
		</div>
	</div>	
	     ...
	     <div class="main">
	       <div class="row">
	            ...
	            <div class="col-sm-10">
					...
					<form:form class="form-horizontal" modelAttribute="serviceOrderQuery" method="post" action="buyermanage.html" role="form">
						...
						<form:hidden path="backendMessage" /> 
								...
								<table class="table table-bordered table-hover table-striped">
									...
									<c:forEach items="${unFinishedOrderList}" var="var" varStatus="rowCounter">
								      <tr>  
									       ...
									       <td>
									       	 <a class="openViewPage" href="view.html?order_id=${var.order_id}">${var.service_title}</a>								         
									       </td>
									       <td>
									         ${var.status}
									       </td>
									       ...
									       <td>									       
												<c:if test="${var.status_id=='10' || var.status_id=='20' || var.status_id=='30'}">
													<a data-href="buyercancel.html?cancelOrderId=${var.order_id}" data-toggle="modal" data-target="#confirm-cancel" href="#" id="cancel-operate" title="${var.order_id}">取消</a>
												</c:if>
												<c:if test="${var.status_id=='20'}">
													<a class="openEditPage" href="complete.html?order_id=${var.order_id}">完成</a>
												</c:if>
												<a class="openEditPage" href="../ticket/create.html">投诉</a>
   ...
   <%@include file="/WEB-INF/inc/loadjs.jsp" %>
	...
	$('#cancel-operate ').click(function(){
		...
		$('#confirm-cancel').on('show.bs.modal', function(e) {
		    ...
		    $('.info').html('即将取消订单ID为: <strong>' +id + '</strong> 的订单。您确定执行取消操作吗?');
		});
 	...
 	function showMessage(){ 		
 		var message = $('#backendMessage').val(); 		
 		$('#backendMessage').val('');
